...
async def search_film_from_scrapping(film_name: str) -> tuple[list[list[dict]], list[str], list[str]]:
    ...
    for idx, item in enumerate(results):
        ...
        if save_res:
            ...
            res = [[[{
                ...
                "rating": moviereview.get("originalrating", "Рейтинг не известен"),
                "description": item.get("snippet", "Описание недоступно") + " " + movie.get("description", ""),
                ...
                "extra_info": {
                    ...
                    "typicalagerange": movie.get("typicalagerange", "Возрастная категория не указана"),
